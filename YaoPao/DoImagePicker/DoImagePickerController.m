...
- (void)initBottomMenu
{
    ...
    _ivLine1.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"sx_line.png"]];
    _ivLine2.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"sx_line.png"]];
...
{
    if(_dSelected.count != self.nMaxCount){
        [kApp.window makeToast:[NSString stringWithFormat:@"请选择共%i张图片~",(int)(self.nMaxCount)]];
        return;
    }
