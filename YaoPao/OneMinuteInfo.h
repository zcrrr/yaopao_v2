...
@interface OneMinuteInfo : NSObject

@property(assign, nonatomic) int number;//第几分钟
@property(assign, nonatomic) double lon;
@property(assign, nonatomic) double lat;
@property(assign, nonatomic) int totalDistance;//跑完这一分钟一共的距离（加上之前的，是从运动开始算起）
@property(assign, nonatomic) int distance;//多少米，例如1005米
@property(assign, nonatomic) int totalDuring;//跑完这个分钟一共用的时间（加上之前的，是从运动开始算起）
@property(assign, nonatomic) int during;//该分钟用时
@property(assign, nonatomic) double totalAltitudeAdd;//跑完这一分钟一共的高程增加值
@property(assign, nonatomic) double altitudeAdd;//每分钟高程增加值
@property(assign, nonatomic) double totalAltitudeReduce;//跑完这一分钟一共的高程降低值
@property(assign, nonatomic) double altitudeReduce;//每分钟总高程降低值
